...
function addFavoriteHandler(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const favorite = (0, lodash_1.get)(req.body, "favorite");
            const product = yield (0, product_service_1.handleFavorite)((0, lodash_1.get)(req.params, "productId"), (0, lodash_1.get)(req, "user.userId"), ActionFavorite.ADD, favorite ? favorite : null);
            if (!product)
