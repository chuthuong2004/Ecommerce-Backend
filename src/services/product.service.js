...
function handleFavorite(productId, userId, actionFavorite, favorite) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (actionFavorite === product_controller_1.ActionFavorite.ADD && !favorite) {
                favorite = {
                    product: product._id,
            ...
            let updateUser;
            if (actionFavorite === product_controller_1.ActionFavorite.ADD && !favoriteForUser) {
                updateUser = { $push: { favorites: favorite } };
            }
            else if (actionFavorite === product_controller_1.ActionFavorite.REMOVE && favoriteForUser) {
