...
function createOrder(input, listCartItemId, userId) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const [cart, user] = yield Promise.all([
                (0, cart_service_1.getCart)({ user: userId }),
                (0, user_service_1.getUser)({ _id: userId }),
            ]);
            if (!cart) {
            ...
            if (((_a = user === null || user === void 0 ? void 0 : user.addresses) === null || _a === void 0 ? void 0 : _a.length) === 0) {
                const res = yield (0, user_service_1.addAddress)(deliveryInformation, user._id);
            }
