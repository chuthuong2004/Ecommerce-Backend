...
// GET ORDER
router.get("/admin/order/:orderId", [middlewares_1.requiresAdmin, (0, middlewares_1.validateRequest)(order_schema_1.getOrderSchema)], order_controller_1.getOrderHandler);
// GET ALL ORDER
