...
//  UPDATE USER
router.put("/me/update", [middlewares_1.requiresUser, (0, middlewares_1.validateRequest)(user_schema_1.updateUserSchema)], user_controller_1.updateProfileHandler);
// ADD ADDRESS
router.post("/me/addresses/add", [middlewares_1.requiresUser, (0, middlewares_1.validateRequest)(user_schema_1.addAddressSchema)], user_controller_1.addAddressHandler);
router.put("/me/addresses/:addressId", [middlewares_1.requiresUser, (0, middlewares_1.validateRequest)(user_schema_1.updateAddressSchema)], user_controller_1.updateAddressHandler);
// =============================ADMIN====================================
// * GET ALL USER ---- Admin
